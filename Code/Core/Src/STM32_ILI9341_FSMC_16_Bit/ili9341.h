...
#include "main.h"
#include <stdbool.h>
#include "../STM32_ILI9341_FSMC_16_Bit/colors.h"
#include "../STM32_ILI9341_FSMC_16_Bit/fonts.h"
#include "../STM32_ILI9341_FSMC_16_Bit/image.h"
#include "../STM32_ILI9341_FSMC_16_Bit/registers.h"

#define LCD_BL_ON() HAL_GPIO_WritePin(LED_LCD_ON_GPIO_Port, LED_LCD_ON_Pin, GPIO_PIN_SET)
#define LCD_BL_OFF() HAL_GPIO_WritePin(LED_LCD_ON_GPIO_Port, LED_LCD_ON_Pin, GPIO_PIN_RESET)
